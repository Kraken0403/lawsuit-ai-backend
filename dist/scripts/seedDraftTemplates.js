...
const templates = [
    {
        ...
        summary: "Used where a debtor acknowledges an existing debt in writing.",
        ...
        rawText: "I [debtor_name] of [debtor_address] hereby acknowledge that I am indebted to [creditor_name] of [creditor_address] in the sum of Rs. [amount] being [basis_of_debt]. Dated [date]. [signature_block]",
        placeholders: [
    ...
    },
    {
        ...
        summary: "Short IOU-style acknowledgement of indebtedness.",
        ...
        rawText: "To [creditor_name] of [creditor_address]. I.O.U. the sum of Rs. [amount] ([amount_words]). Signed by [debtor_name] of [debtor_address] on [date].",
        placeholders: [
            { key: "creditor_name", label: "Creditor name", type: "text", required: true },
            { key: "creditor_address", label: "Creditor address", type: "address", required: true },
            { key: "amount", label: "Amount", type: "amount", required: true },
    ...
    },
    {
        ...
        summary: "Used where borrower acknowledges receipt of an unsecured loan and agrees to repay.",
        ...
        rawText: "I [debtor_name] of [debtor_address] hereby acknowledge that [creditor_name] of [creditor_address] has advanced to me the sum of Rs. [amount] ([amount_words]) by way of loan free of interest and I agree to repay the same on demand. Dated [date]. [signature_block]",
        placeholders: [
    ...
    },
    {
        ...
        summary: "Used to record part payment of an existing debt or pronote amount.",
        ...
        rawText: "I [debtor_name] of [debtor_address] hereby acknowledge that on [date] I paid a sum of Rs. [paid_amount] in part payment of the debt of Rs. [total_debt] borrowed by me from [creditor_name] of [creditor_address] on a pronote dated [pronote_date]. [signature_block]",
        placeholders: [
            { key: "debtor_name", label: "Debtor name", type: "text", required: true },
            { key: "debtor_address", label: "Debtor address", type: "address", required: true },
    ...
    },
    {
        ...
        summary: "Letter-style acknowledgement confirming liability and inability to pay immediately.",
        ...
        rawText: "Dear Sir/Madam, I acknowledge receipt of your demand regarding the sum of Rs. [amount]. I regret my inability to make payment immediately, but I acknowledge the correctness of the amount and my liability to pay the same. Dated [date]. Yours faithfully, [debtor_name]",
        placeholders: [
            { key: "amount", label: "Amount", type: "amount", required: true },
            { key: "date", label: "Date", type: "date", required: true },
            { key: "debtor_name", label: "Debtor name", type: "text", required: true },
...
async function upsertSystemTemplate(template) {
...
//# sourceMappingURL=seedDraftTemplates.js.map