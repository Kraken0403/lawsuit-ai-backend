  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        role: "assistant",
        content:
          "The newest visible Gujarat murder decision in the supplied evidence is Raval Shaileshbhai Rameshbhai Virchandbhai v. State of Gujarat, followed by Pintubhai @ Kaliyo Dolubhai Vasava v. State of Gujarat and Raju @ Rajubhai Haribhai Gohel v. State of Gujarat.",
        caseDigests: [
          {
            caseId: 472507,
...
function buildLatestSmokeCases(): EvalCase[] {
  const out: EvalCase[] = [];
...
function buildDateSmokeCases(): EvalCase[] {
  const out: EvalCase[] = [];
...
function buildIssueSmokeCases(): EvalCase[] {
  return [
    {
      id: "issue_fake_citation_karnataka",
      category: "issue_search",
      query:
        "Judgements on Karnataka High Court orders actions against a civil court for citing non-existant supreme court judgement",
      expectation: {
        expectedIntent: "issue_search",
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Karnataka High Court civil judge cited non-existent Supreme Court judgment",
      expectation: {
        expectedIntent: "issue_search",
        topCourtIncludes: "Karnataka",
        minGroupedCases: 1,
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Karnataka High Court strictures against trial court for fabricated Supreme Court citation",
      expectation: {
        expectedIntent: "issue_search",
        topCourtIncludes: "Karnataka",
        minGroupedCases: 1,
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Delhi High Court cases on seat versus venue in arbitration",
      expectation: {
        expectedIntent: "issue_search",
        topCourtIncludes: "Delhi",
        minGroupedCases: 1,
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Gujarat High Court cases where delay in trial was considered for bail",
      expectation: {
        expectedIntent: "issue_search",
        topCourtIncludes: "Gujarat",
        minGroupedCases: 1,
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Karnataka High Court judgments on disciplinary proceedings and service law",
      expectation: {
        expectedIntent: "issue_search",
        topCourtIncludes: "Karnataka",
        minGroupedCases: 1,
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Bombay High Court judgments on arbitration clause and contract dispute",
      expectation: {
        expectedIntent: "issue_search",
    ...
    },
    {
      ...
      category: "issue_search",
      query:
        "Supreme Court murder conviction based on circumstantial evidence",
      expectation: {
        expectedIntent: "issue_search",
        topCourtIncludes: "Supreme Court",
        minGroupedCases: 1,
...
function buildComparisonCases(): EvalCase[] {
  return [
    {
...
function buildFollowUpCases(): EvalCase[] {
  const delhiAssistantMessage = {
    role: "assistant" as const,
    content:
      "The newest visible Delhi arbitration cases include M/S Kanodia Technoplast Limited v. M/S A P Trading Company, Vivek Slaria v. Neeraj Tyagi, and S P Singla Constructions Private Limited v. Construction and Design Services.",
    caseDigests: [
      {
        caseId: 299798,
      ...
      },
      {
        caseId: 298938,
        title:
          "S P SINGLA CONSTRUCTIONS PRIVATE LIMITED V/S CONSTRUCTION AND DESIGN SERVICES, UTTAR PRADESH JAL NIGAM",
...
async function main() {
  ...
  const deduped = new Map<string, EvalCase>();
